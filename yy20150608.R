...
write.xlsx(file="./doc/yy_2345_data_mean_result_byhour.xlsx",meanuser)
write.xlsx(file="./doc/yy_2345_data_uid_result_byhour.xlsx",uniqueuid)
write.xlsx(file="./doc/yy_2345_data_sid_result_byhour.xlsx",uniquesid)
